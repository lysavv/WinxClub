...
<head>
    ...
    <title>Destinasi - Jejak Negeri Atas Awan</title>
...
<body>
    ...
    <main class="content-area-with-sidebar">
        ...
        <header class="hero-header">
            <div class="hero-text">
                <p style="text-transform: uppercase; letter-spacing: 4px; font-weight: 600; margin-bottom: 10px; opacity: 0.8;">Eksplorasi</p>
                <h1>Alam Dieng.</h1>
            </div>
        </header>
        ...
        <section class="white-content-section">
            ...
            <div class="grid-container">
                ...
                $sql = "SELECT * FROM items WHERE category='wisata'";
