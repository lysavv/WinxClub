...
<head>
    ...
    <title>Akomodasi - Jejak Negeri Atas Awan</title>
...
<body>
    ...
    <main class="content-area-with-sidebar">
        ...
        <header class="hero-header">
            <div class="hero-text">
                <p style="text-transform: uppercase; letter-spacing: 4px; font-weight: 600; margin-bottom: 10px; opacity: 0.8;">Istirahat Sejenak</p>
                <h1>Akomodasi Nyaman.</h1>
            </div>
        </header>

        <!-- White Section -->
        <section class="white-content-section">
            <h2>Pilihan Penginapan</h2>
            <div class="grid-container">
                <?php
                include 'db_config.php';
                $sql = "SELECT * FROM items WHERE category='penginapan'";
